...
namespace TwentyOne
{
    public class TwentyOneRules
    {
        ...
        private static int[] GetAllPossibleValues(List<Card> Hand)
        {
            ...
            int[] result = new int[aceCount + 1]; // must declare length of array
            // for aces, the amount of possibilities of values for the aces is one more than the amount of aces
            // (1 ace, 2 poss values 1 or 11... 2 aces, 3 poss values 2, 12, 22)
